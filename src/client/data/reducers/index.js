...
const guestBar = (state = null, action) => {
  switch (action.type) {
...
const loginDialogOpen = (state = false, action) => {
  switch (action.type) {
...
const loginMenuOpen = (state = false, action) => {
  switch (action.type) {
...
const messageDialogOpen = (state = false, action) => {
  switch (action.type) {
    ...
    case actionTypes.FACEBOOK_LOGIN_ADD_SUCCESS:
    case actionTypes.FACEBOOK_LOGIN_ADD_ERROR:
      return true;
    default:
      return state;
  }
...
const listDialogOpen = (state = false, action) => {
  switch (action.type) {
...
const basketDialogOpen = (state = false, action) => {
  switch (action.type) {
